    ...
    <main className="exercise-page">
      ...
      <style jsx global>{`
        .exercise-page {
          width: 100%;
          min-height: 100vh;
          padding: clamp(24px, 3vw, 42px) clamp(20px, 3.5vw, 56px) 56px;
        ...
        .exercise-grid {
          ...
          margin: 0 auto;
          display: grid;
          grid-template-columns: minmax(250px, 0.85fr) minmax(480px, 1.8fr) minmax(285px, 1.05fr);
        ...
        @media (max-width: 1200px) {
          .exercise-grid {
            grid-template-columns: minmax(220px, 0.8fr) minmax(430px, 1.6fr) minmax(250px, 0.95fr);
            gap: 14px;
          }
