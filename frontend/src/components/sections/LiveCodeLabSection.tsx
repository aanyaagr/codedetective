        ...
        {!mounted ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 rounded-xl border-2 border-amber-600/40 bg-[#090C14] overflow-hidden font-mono">
              <div className="bg-[#121622] px-4 py-3 border-b border-amber-500/20 flex items-center justify-between"><span className="text-slate-300 font-bold text-xs flex items-center gap-2"><FileCode className="w-4 h-4 text-amber-400" /> challenge.{caseData.challenge.language}</span><span className="text-[10px] text-amber-400">{caseData.challenge.language.toUpperCase()}</span></div>
