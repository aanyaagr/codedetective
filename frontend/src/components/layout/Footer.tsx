        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 space-y-3">
            <Link href="/" className="flex items-center gap-3 group inline-flex">
              ...
              <div className="flex flex-col">
                <span className="text-base font-black tracking-wider text-amber-400 font-sans">
                  {FOOTER_DATA.brand}
                </span>
                <span className="text-[9px] tracking-[0.35em] font-black text-red-500/90 font-mono">
                  {FOOTER_DATA.subBrand} // {FOOTER_DATA.precinct}
                </span>
              </div>
            </Link>
          ...
          {FOOTER_DATA.columns.map((col) => (
            <div key={col.title} className="col-span-1 md:col-span-2 space-y-3">
              <h4 className="text-xs font-mono font-black tracking-widest text-slate-200 uppercase border-b border-red-950/60 pb-1">
                {col.title}
              </h4>
